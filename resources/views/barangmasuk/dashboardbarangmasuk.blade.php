        ...
        <div class="grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('cari-barang-masuk')}}" class="form-sample" method="GET">
                        @csrf
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-between gap-1">
                                ...
                                <form action="{{route('barangmasuk.destroy',[$barangmasuks[$i]->id])}}" method="POST" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
